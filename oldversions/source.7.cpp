...
public:
  ...
  metapoints(const int w, const int h, int pointspercurve)
  {
    ...
    this->c2.p1.x = this->c1.p1.x + (this->c1.p2.x - this->c1.p1.x) / 2;
    this->c2.p1.y = this->c1.p1.y + (this->c1.p2.y - this->c1.p1.y) / 2;
    this->c2.p2 = this-> c1.p2;
    this->c2.p3.x = this->c1.p3.x + (this->c1.p3.x - this->c1.p2.x) / 2;
    this->c2.p3.y = this->c1.p3.y + (this->c1.p3.y - this->c1.p2.y) / 2;
    this->pointspercurve = pointspercurve;
    auto curvepoints = beziercurve_quadratic(c2.p1, c2.p2, c2.p3, pointspercurve);
  ...
  point getpoint()
  {
    ...
    if (this->pointindex >= this->cpsize)
    {
      ...
      this->pointindex = 0;
      auto curvepoints = beziercurve_quadratic(c2.p1, c2.p2, c2.p3, this->pointspercurve);
