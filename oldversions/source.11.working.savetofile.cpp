...
void drawscreen(SDL_Renderer* renderer, int w, int h, vector<point> disppoints, GifWriter& writer)
{
  for (int x = 0; x < w; x++)
  {
    for (int y = 0; y < h; y++)
...
int main(int argc, char* argv[])
{
  ...
  //{
    ...
    { 
      ...
      drawscreen(renderer, w, h, createdisploop(createpercloop(dispanchors, pointsperspacecurve)), writer);
