...
vector<point> beziercurve_quadratic(point p1, point p2, point p3, int pointspercurve)
{
  ...
  cout << "points.size(): " << points.size() << " " << "pointspercurve: " << pointspercurve << endl;
  return points;
}
...
vector<point> createpercloop(vector<point> anchors, int pointspercurve)
{
  ...
  for (int i = 0; i < s; i++)
  {
    ...
    //cout << "(i + 2) % s: " << (i + 2) % s << " anchors.size(): " << s << endl;
    point p1c, p2c, p3c;
  ...
  for (const auto& p : curves)
  {
    ...
    cout << "pointspercurve: " << pointspercurve << endl;
...
int main(int argc, char* argv[])
{
  ...
  else
  {
    ...
    for (int i = 0; i < spacecurves; i++)
    {
      ...
      cout << "making timeperanchors: timepercanchors[i].size(): " << timepercanchors[i].size() << endl;
    }
    vector<point> dispanchors;
    ...
    for (;;)
    {
      ...
      {
        cout << "i2: " << i2 << " timecurves * (pointspertimecurve+1): " << timecurves * (pointspertimecurve + 1) << endl;

        for (int i = 0; i < spacecurves; i++)
        {
          //cout << "timepercanchors.size(): " << timepercanchors->size() << " timepercanchors[i].size(): " << timepercanchors[i].size() << endl;
