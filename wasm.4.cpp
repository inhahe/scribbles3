...
int main(int argc, char* argv[])
{
  ...
  */
  ...
  if (SDL_CreateWindowAndRenderer(context.w, context.h, 0, &context.window, &context.renderer))
  {
    prnjs("SDL_CreateWindowAndRenderer(w, h, 0, &context.window, &context.renderer)", SDL_GetError());
    exit(EXIT_FAILURE);
  }
