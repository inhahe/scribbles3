...
void parsecommandline(int argc, char* argv[])
{
  try
  {
    ...
    if (vm.count("pointsperspacecurve")) pointspertimecurve = vm["pointsperspacecurve"].as<int>();
    if (vm.count("pointsperstimecurve")) pointspertimecurve = vm["pointspertimecurve"].as<int>();
  }
